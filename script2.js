...
document.getElementById("btn-registro").addEventListener("click", readmore);
    ...
    swalWithBootstrapButtons.fire({
      ...
      if (result.isConfirmed) {
        swalWithBootstrapButtons.fire(
          'Enviado!',
          'O Registro foi enviado corretamente.',
          'success'
        )
      } else if (
  ...
  /* FIM READMORE - REGISTRO */

  /* READMORE - RELATOS */

  document.getElementById("more-relato").addEventListener("click", leiamais);
    function leiamais() {
    const swalWithBootstrapButtons = Swal.mixin({
      customClass: {
        confirmButton: 'btn btn-success',
    ...
    swalWithBootstrapButtons.fire({
      title: '<p style = "font-size: 25px", "text-transform= uppercase"> </br> MAIRA S. DOS SANTOS </p>',
	  html: '<br><p style="font-size:17px", "text-align: justify"> <b>Marlon Sakszewski Silveira</b>, de 21 anos, desapareceu no dia 04/11/2022. Segundo as informações repassadas pela família, Silveira, natural de Caxias do Sul, saiu da casa, na Rua Venâncio Aires, no Centro, por volta das 6h30min do sábado levando apenas uma mochila e a carteira de habilitação. O jovem estava vestindo um moletom preto, óculos escuros, boné e um tênis. Familiares acreditam que ele tenha ido ao  Litoral em busca de emprego. </br> De acordo com o relato da mãe, Maira Sakszewski dos Santos, ele teria ido até a rodoviária de Caxias na semana passada comprar uma passagem, mas ninguém sabe o destino. Segundo ela, o celular de Silveira não recebe ligações desde sábado. </br></br>" — Ele é um menino bom, não usa drogas e tem ótimas referências de quando fez parte do Exército. Ele pode ter ido buscar trabalho, uma nova oportunidade, mas não conseguimos contato com ele — desabafa a mãe, que também recebeu informações de que o filho foi visto recentemente em Balneário Atlântico."</br></br>Fonte: GZH</p>',
            imageWidth: '400px',
            imageHeight: '450px',
      showCancelButton: true,
      confirmButtonText: 'Confirmar',
      ...
      if (result.isConfirmed) {
        swalWithBootstrapButtons.fire(
          'Enviado!',
          'Relato publicado com sucesso! parabéns pela iniciativa, estamos com você.',
          'success'
        )
      } else if (
        result.dismiss === Swal.DismissReason.cancel
        ...
        swalWithBootstrapButtons.fire(
          'Cancelado',
          'Oh Oh, seu relato não foi publicado! :(',
          'error'
        )
      }
    })
